import { sortedFilms, getDetails, getFilmsByResult, formatDetail, trimDetail } from '../FilterData';
...
describe('FilterData test', () => {
    ...
    it('trimDetail should return a trimmed string if the lenght is > 28', () => {
        expect(trimDetail('that is a really really long string')).toEqual('that is a really really l...');
    });

    it('trimDetail should return the same string if the lenght is <= 28', () => {
        expect(trimDetail('that is a medium long string')).toEqual('that is a medium long string');
    });
});